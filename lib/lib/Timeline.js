  ...
  _createClass(ReactCalendarTimeline, [{
    ...
    value: function __touchMove__REACT_HOT_LOADER__(e) {
      ...
      if (this.lastTouchDistance && e.touches.length === 2) {
        ...
        var parentPosition = (0, _utils2.getParentPosition)(e.currentTarget);
    ...
    value: function __touchEnd__REACT_HOT_LOADER__(e) {
      ...
      if (this.lastSingleTouch) {
        ...
        if (this.lastSingleTouch.x == this.singleTouchStart.x && this.lastSingleTouch.y == this.singleTouchStart.y) {
          ...
          var realOffset = parentPosition.y - screenY;
          if (realOffset > 0) {
    ...
    value: function __onWheel__REACT_HOT_LOADER__(e) {
      ...
      if (e.ctrlKey || e.metaKey || e.altKey) {
        ...
        if (e.deltaY !== 0) {
          ...
          if (traditionalZoom) {
            var _parentPosition = (0, _utils2.getParentPosition)(e.currentTarget);
    ...
    value: function __showPeriod__REACT_HOT_LOADER__(from, unit) {
      ...
      if (unit !== 'year' && this.state.visibleTimeStart === visibleTimeStart && this.state.visibleTimeEnd === visibleTimeEnd) {
        var nextUnit = (0, _utils2.getNextUnit)(unit);
    ...
    value: function __rowAndTimeFromEvent__REACT_HOT_LOADER__(e) {
      ...
      var lineCount = (0, _utils2._length)(this.props.groups);
    ...
    value: function __scrollAreaClick__REACT_HOT_LOADER__(e) {
      ...
      if (!(0, _utils2.hasSomeParentTheClass)(e.target, 'rct-item')) {
        if (this.state.selectedItem) {
          ...
          if (row >= 0 && row < this.props.groups.length) {
            var groupId = (0, _utils2._get)(this.props.groups[row], this.props.keys.groupIdKey);
    ...
    value: function __dragItem__REACT_HOT_LOADER__(item, dragTime, newGroupOrder) {
      ...
      this.setState({
        ...
        dragGroupTitle: newGroup ? (0, _utils2._get)(newGroup, keys.groupTitleKey) : ''
      });
    }
  }, {
    ...
    value: function todayLine(canvasTimeStart, zoom, canvasTimeEnd, canvasWidth, minUnit, height, headerHeight) {
      return _react2.default.createElement(_TodayLine2.default, { canvasTimeStart: canvasTimeStart,
        ...
        lineCount: (0, _utils2._length)(this.props.groups),
        height: height,
    ...
    value: function stackItems(items, groups, canvasTimeStart, visibleTimeStart, visibleTimeEnd, width) {
      ...
      var visibleItems = (0, _utils2.getVisibleItems)(items, canvasTimeStart, canvasTimeEnd, keys);
      var groupOrders = (0, _utils2.getGroupOrders)(groups, keys);

      var dimensionItems = visibleItems.reduce(function (memo, item) {
        var itemId = (0, _utils2._get)(item, keys.itemIdKey);
        var isDragging = itemId === draggingItem;
        var isResizing = itemId === resizingItem;

        var dimension = (0, _utils2.calculateDimensions)({
          itemTimeStart: (0, _utils2._get)(item, keys.itemTimeStartKey),
          itemTimeEnd: (0, _utils2._get)(item, keys.itemTimeEndKey),
        ...
        if (dimension) {
          dimension.top = null;
          dimension.order = isDragging ? newGroupOrder : groupOrders[(0, _utils2._get)(item, keys.itemGroupKey)];
      ...
      var stackingMethod = stackItems ? _utils2.stack : _utils2.nostack;
    ...
    value: function render() {
      ...
      var canvasTimeEnd = canvasTimeStart + zoom * 3;
      var canvasWidth = width * 3;
      var minUnit = (0, _utils2.getMinUnit)(zoom, width, timeSteps);
      var headerHeight = headerLabelGroupHeight + headerLabelHeight;
...
ReactCalendarTimeline.propTypes = {
  ...
  timeSteps: _propTypes2.default.shape({
    ...
    week: _propTypes2.default.number,
